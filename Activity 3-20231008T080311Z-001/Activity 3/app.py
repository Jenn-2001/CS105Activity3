...
Original file is located at
    https://colab.research.google.com/drive/1SD23iIFClV048YfN9oHVFTBsoQ0X_1vA
"""
...
def predict():
    ...
    return render_template('Jennifer.html', prediction_text='Predicted Profit: {}'.format(output))
